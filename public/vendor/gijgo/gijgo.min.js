...
gj.widget = function () {
    ...
    config: {
        base: {
            ...
            keepExpandedRows: !0,
            expandedRows: [],
            icons: {expandRow: '<i class="fa fa-angle-right" />', collapseRow: '<i class="gj-icon chevron-down" />'}
        },
        fontawesome: {
            icons: {
    ...
    base: {
        ...
        icons: {expand: '<i class="fa fa-angle-right" />', collapse: '<i class="gj-icon chevron-down" />'}
    },
    bootstrap: {
        style: {
    ...
    init: function (a) {
        ...
        return function (e) {
            return e && e.stopPropagation(), gj.datepicker.methods.selectDay(a, b, c, d), !0 !== c.footer && !1 !== c.autoClose && gj.datepicker.methods.change(a, b, c, d), a, myFunc()
        }
