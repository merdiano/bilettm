...
<li class="nav-item">
    <a class="nav-link" href="#"><i class="fa fa-group"></i> <span>Users, Accounts, Organizers</span> <i class="fa fa-angle-left pull-right"></i></a>
    <ul class="treeview-menu">
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('user') }}"><i class="fa fa-user"></i> <span>Users</span></a></li>
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('account') }}"><i class="fa fa-group"></i> <span>Accounts</span></a></li>
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('organiser') }}"><i class="fa fa-key"></i> <span>Organizers</span></a></li>
    </ul>
</li>
{{--<li class="treeview">--}}
