@if(count($ticket_dates) > 0)
    ...
    @else
        <h4 class="date-small-title mt-3" style="font-size: 26px;">@lang('ClientSide.event_dates')</h4>
        ...
        <h4 class="time-small-title" style="font-size: 26px;">@lang('ClientSide.event_times')</h4>
