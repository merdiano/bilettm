...
return array (
    ...
    'maximum_tickets_per_order' => 'Макс. кол-во билетов на заказ',
    ...
    'minimum_tickets_per_order' => 'Мин. кол-во билетов на заказ',
    'more_options' => 'Больше опций',
    'no_attendees_matching' => 'Нет подходящих посетителей',
    'no_attendees_yet' => 'Пока нет участников',
    'no_attendees_yet_text' => 'Участников пока нет. Они добавятся, как только зарегистрируются на событии.',
    'no_orders_yet' => 'Пока заказов нет',
    ...
    'widgets' => 'Виджеты',
    'select_section' =>'Выберите сектор',
    'LLH:obsolete' =>
        array (
