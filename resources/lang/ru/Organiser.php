...
return array (
  ...
  'create_organiser_text' => 'Прежде чем создавать события, вам нужно создать организатора. Организатор - тот, кто организует событие. Организатором может выступать физ. лицо или юр. лицо.',
  'current_logo' => 'Текущий логотип',
  'customize' => 'Подробности события',
  'dashboard' => 'Панель',
  ...
  'organiser_events' => 'События организатора',
  'organiser_facebook' => 'Facebook организатора',
  'organiser_facebook_placeholder' => 'E.g http://www.facebook.com/MyFaceBookPage',
  'organiser_logo' => 'Логотип Организатора',
  'organiser_logo_help' => 'Мы рекомендуем квадратное изображение, так как оно будет лучше всего смотреться на распечатанных билетах и страницах события.',
  'organiser_menu' => 'Меню Организатора',
  'organiser_name' => 'Имя организатора',
  'organiser_name_dashboard' => ':name панель',
  'organiser_name_events' => 'События :name ',
  'organiser_name_placeholder' => 'Кто организует событие?',
